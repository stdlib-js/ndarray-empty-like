...
/**
* Creates an uninitialized half-precision floating-point array having the same shape as a provided input ndarray.
*
* @param x - input array
* @param options - options
* @param options.dtype - output array data type
...
* // returns 'float16'
*/
declare function emptyLike( x: ndarray, options: Float16Options ): float16ndarray;
