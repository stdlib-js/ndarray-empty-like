...
tape( 'the function returns an uninitialized array (dtype=float16, inferred)', function test( t ) {
	var arr;
	var x;
	...
	t.strictEqual( instanceOf( arr, ndarray ), true, 'returns expected value' );
	t.strictEqual( isEqualDataType( getDType( arr ), 'float16' ), true, 'returns expected value' );
	t.deepEqual( getShape( arr ), [ 2, 2 ], 'returns expected value' );
...
tape( 'the function returns an uninitialized array (dtype=float16, options)', function test( t ) {
	var arr;
	var x;
